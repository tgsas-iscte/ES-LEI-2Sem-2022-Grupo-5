...
public class BergeGraphInspectorProduct {
	/**
	...
	*/
	public <V, E> boolean isYXComplete(Graph<V, E> g, V y, Set<V> x) {
	...
	*/
	public <V, E> Set<V> findMaximalConnectedSubset(Graph<V, E> g, Set<V> setX, V v1, V v2, V v5) {
	...
	*/
	public <E, V> boolean hasANeighbour(Graph<V, E> g, Set<V> set, V v) {
	...
	*/
	public <V, E> boolean hasANonneighbourInX(Graph<V, E> g, V v, Set<V> setX) {
