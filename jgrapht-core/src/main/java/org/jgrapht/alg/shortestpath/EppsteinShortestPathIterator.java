...
{
    private EppsteinShortestPathIteratorProduct1 eppsteinShortestPathIteratorProduct1 = new EppsteinShortestPathIteratorProduct1();
	/**
     * Underlying graph.
     */
    ...
    private Pair<PathsGraphVertex, PathsGraphVertex> getOutrootAndRestHeapRoot(V v)
    {
        ...
        if (size > 0) {
        	EppsteinShortestPathIteratorProduct1.heapify(null, size);
